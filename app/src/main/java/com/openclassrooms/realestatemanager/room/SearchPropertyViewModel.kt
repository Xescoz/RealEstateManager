...
class SearchPropertyViewModel(private val propertyRepository: PropertyRepository): ViewModel() {
    ...
    fun getPropertyMatch(city: String, numberOfPhotos: Int, pointOfInterest: String, date: String, dateOfSale: String, minPrice: Int, maxPrice: Int, minSize: Int, maxSize: Int): LiveData<List<Property>> {
        return propertyRepository.getPropertyMatch(city, numberOfPhotos,pointOfInterest,date,dateOfSale,minPrice, maxPrice,minSize, maxSize).asLiveData()
    }
